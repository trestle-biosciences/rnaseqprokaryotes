//
// Subworkflow with functionality specific to the trestlebiosciences/rnaseqprokaryotes pipeline
//
...
def toolBibliographyText() {
    def reference_text = [
            ...
            "<li>Krueger F. Trim Galore! URL: https://www.bioinformatics.babraham.ac.uk/projects/trim_galore/.</li>",
            "<li>Langmead B, Salzberg SL. Fast gapped-read alignment with Bowtie 2. Nature Methods. 2012;9(4):357-359. doi: 10.1038/nmeth.1923.</li>",
            "<li>Pertea G, Pertea M. GFF Utilities: GffRead and GffCompare. F1000Research. 2020;9:304. doi: 10.12688/f1000research.23297.1.</li>",
            "<li>Liao Y, Smyth GK, Shi W. featureCounts: an efficient general purpose program for assigning sequence reads to genomic features. Bioinformatics. 2014;30(7):923-930. doi: 10.1093/bioinformatics/btt656.</li>",
