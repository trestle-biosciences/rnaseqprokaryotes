...
# `trestlebiosciences/rnaseqprokaryotes`: Contributing guidelines

Hi there!
Thanks for taking an interest in improving trestlebiosciences/rnaseqprokaryotes.

This page describes the recommended nf-core way to contribute to both trestlebiosciences/rnaseqprokaryotes and nf-core pipelines in general, including:

- [General contribution guidelines](#general-contribution-guidelines): common procedures or guides across all nf-core pipelines.
- [Pipeline-specific contribution guidelines](#pipeline-specific-contribution-guidelines): procedures or guides specific to the development conventions of trestlebiosciences/rnaseqprokaryotes.
...
- [ ] Check whether a GitHub [issue](https://github.com/trestlebiosciences/rnaseqprokaryotes/issues) about your idea already exists. If an issue does not exist, create one so that others are aware you are working on it.
- [ ] [Fork](https://help.github.com/en/github/getting-started-with-github/fork-a-repo) the [trestlebiosciences/rnaseqprokaryotes repository](https://github.com/trestlebiosciences/rnaseqprokaryotes) to your GitHub account.
...
nf-core semi-standardises how you write code and other contributions to make the trestlebiosciences/rnaseqprokaryotes code and processing logic more understandable for new contributors and to ensure quality.
